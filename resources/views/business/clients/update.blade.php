                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="text" name="first_name" value="{{$client->first_name}}" class="form-control first_name"
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="text" name="last_name" value="{{$client->last_name}}" class="form-control last_name"
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="email" name="email" value="{{$client->email}}" class="form-control email"
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="text" name="contact" value="{{$client->contact}}" class="form-control contact number_only_val" maxlength="10"
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block select-gender">
                                    ...
                                    <div class="status-toggle d-flex justify-content-between align-items-center">
                                        <input type="checkbox" id="status" name="status" {{$client->status == 1 ? 'checked' : ''}} class="check">
    ...
    <script>
        ...
        $('#submitForm').submit(function(e) {
            ...
            $.ajax({
                ...
                url: "{{ route('business.clients.update') }}",
                data: formData,
                contentType: false,
                cache: false,
                processData: false,

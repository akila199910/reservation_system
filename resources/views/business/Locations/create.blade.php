        ...
        <div class="row">
            <div class="col-sm-8">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create new Business Location</li>
                </ul>
            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-heading">
                                    <h4>Create New Business Location</h4>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="text" name="contact_no" class="form-control contact_no number_only_val"
                                        id="contact_no" maxlength="10">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block local-forms">
                                    ...
                                    <input type="text" name="google_location" class="form-control google_location"
                                        id="google_location" maxlength="190">
                            ...
                            <div class="col-12 col-md-6 col-xl-6">
                                <div class="input-block select-gender">
                                    <label class="gen-label">Is Default <small class="text-primary">(If enable this location, existing
                                            default change to no)</small></label>
                                    <div class="status-toggle d-flex justify-content-between align-items-center">
...
@section('scripts')
{{-- <script src="https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=places&key=AIzaSyALI1s4naJlQ35vpGOAcQFV-X1jze6m408"></script> --}}
            ...
            $('#submitForm').submit(function(e) {
                ...
                let formData = new FormData($('#submitForm')[0]);
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('business.Locations.create') }}",
                        data: formData,
                        dataType: "JSON",
                        contentType: false,
                        cache: false,
                ...
                function clearError() {
                    ...
                    const fields = ['bname', 'location_name', 'email', 'contact_no', 'google_location', 'address'];
                    fields.forEach(function(field) {
                        $('#' + field).removeClass('is-invalid');
                        $('.err_' + field).text('');
                    });

                // Clear errors for open_time and close_time fields
                const days = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday'];
                days.forEach(function(day) {
                    $('#open_time_' + day).removeClass('is-invalid');
                    $('.err_open_time_' + day).text('');

                    $('#close_time_' + day).removeClass('is-invalid');
                    $('.err_close_time_' + day).text('');
                });
            }

            ...
            @foreach ($elements as $item)
                <div class="custom-radio-section-table">
                    ...
                    <label for="element_{{ $item->id }}">
                        <img src="{{ $item->normal_image }}" title="{{ $item->layout_name }}" alt="element {{ $item->id }}">
                    </label>
                </div>
            @endforeach
        @else
...
<script>
    ...
    $(document).ready(function() {
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: "{{ route('business.cafe.get_stored_element_id') }}",
        //         dataType: "JSON",
        //         success: function(response) {
        //             if (response.status === true) {
        //                 // Check and update the dynamically created element
        //                 let elementSelector = $('#element_search_' + response.element_id);
        //                 if (elementSelector.length) {
        //                     elementSelector.prop('checked', true);
        //                 } else {
        //                     console.warn('Element not found: #element_search_' + response
        //                         .element_id);
        //                 }
        //             }
        //         },
        ...
        //         },
        //         error: function(data) {
        //             console.error('Error fetching selected element:', data);
        //             someThingWrong();
        //         }
        //     });
        // }

        // $(document).on('change', 'input[name="element"]', function() {
        //     selected_element_id = $(this).val();
        ...
        //     $.ajax({
        //         type: "POST",
        //         url: "{{ route('business.cafe.store_element_id') }}",
        //         data: data,
        //         dataType: "JSON",
        //         success: function(response) {

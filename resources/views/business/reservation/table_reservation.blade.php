<div class="row">
                ...
                @foreach ($tables as $key => $item)
                    <div class="custom-radio-table">
                        ...
                        <label for="table_{{ $item['id'] }}">
                            <img src="{{ $item['image'] }}" alt="table {{ $item['id'] }}">
        ...
        <div class="col-12 col-md-4 col-xl-4">
            <div class="input-block local-forms">
                ...
                <select name="no_of_people" class="form-control no_of_people select2" id="no_of_people">
                    <option value="">--select a no from 1-10--</option>
                    @for ($i = 1; $i <= 10; $i++)
        ...
        <div class="col-12 col-md-4 col-xl-4">
            <div class="input-block local-forms">
                ...
                <input type="text" name="no_of_extra_people" id="no_of_extra_people"
                    class="no_of_extra_people form-control number_only_val" value="0">
            ...
            <div class="row">
                ...
                <div class="col-12 col-md-12 col-xl-12">
                    <div class="input-block local-forms">
                        ...
                        <input type="text" readonly name="total_amount" value="0.00"
    ...
    @else
        <div class="col-12 col-md-12 col-xl-12 text-center mt-5">
            <h4 class="text-danger">No Table Found!</h4>
        </div>
    @endif

$(document).ready(function ($) {
    ...
    if ($('.datetime_pickers').length > 0) { $(function () { $('.datetime_pickers').datetimepicker({ format: 'LT', stepping: 15, icons: { up: "fas fa-angle-up", down: "fas fa-angle-down", next: 'fas fa-angle-right', previous: 'fas fa-angle-left' } }); }); }

            ...
            clickListener: function () {
                ...
                t.data("spaceSelect", !1), this.$button.on("keyup", function (e) {
                    ...
                    if(i.hasClass('selected')){
                            i.parent().nextUntil('.dropdown-divider').addClass('subinner-active')
                    }else {
                        i.parent().nextUntil('.dropdown-divider').each(function() {
                            if(i.parent().nextUntil('.dropdown-divider').children().hasClass('selected')){
                                z('li a.sub-inner.selected').click()
                
                            }
                        });
                        i.parent().nextUntil('.dropdown-divider').removeClass('subinner-active');
                    }
